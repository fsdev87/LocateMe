...
class ChatMessagesAdapter(
    ...
    inner class ChatMessageViewHolder(itemView: android.view.View) :
        ...
        fun bind(message: ChatMessage) {
            ...
            if (message.type == "sent") {
                rowContainer.gravity = android.view.Gravity.END
                ...
                rowContainer.gravity = android.view.Gravity.START
